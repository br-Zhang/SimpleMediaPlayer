...
public class PlayListTest {
	...
	public void testSavingPlayList() {
		...
		try {
			PrintWriter printWriter = new PrintWriter(new FileWriter(fileCurrentPlayList.getAbsolutePath()));
	...
	public void testOpeningPlayList() {
		...
		VerificationUtils.verify(playList.getFilePaths(), expectedFilePaths, "File path of the PlayList");
	}
	...
	public void testSaveAsPlayList() {
		...
		VerificationUtils.verify(playListTwo.getFilePaths(), Arrays.asList(saveAsFilePaths), "Save As File paths");
	}
}
